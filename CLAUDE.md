...
- `Core/Aion2Dat.cs` — ALL AION2-specific .dat decoding isolated here (CUE4Parse
  GameTypes/Aion2 readers; MapEvent = decrypted JSON text; non-MapData files under
  Data/Map get the empty default — parsing them crashes with StackOverflow).
...
- CUE4Parse pins: net10.0-only package. When bumping, re-run doctor + an export diff.
